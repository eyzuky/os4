...
void sanityCheck()
{
    ...
    if (resultsFileInput.is_open()) {
        ...
        if (strcmp(cacheResults, "/tmp/sanity_test.txt 5\n/tmp/sanity_test.txt 0\n")) {
            ok = false;
            std::cout << "Test 10: " << "Expected: " << "/tmp/sanity_test.txt 5\n/tmp/sanity_test.txt 0\n" << " Actual: " << cacheResults << std::endl;}
    }
